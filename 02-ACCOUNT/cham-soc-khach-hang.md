...
flowchart LR
    subgraph P1["Phase 1: Kickoff"]
        O1["Onboarding KH"]
        O2["Welcome Pack"]
        O3["Setup kênh liên lạc"]
    end

    subgraph P2["Phase 2-3: TK & Chọn NT"]
        M1["Check-in hàng tuần"]
        M2["Cập nhật tiến độ TK"]
        M3["Hỗ trợ chọn NT/NCC"]
    end
    ...
    subgraph P56["Phase 5-6: BG & BH"]
        E1["Bàn giao công trình"]
        E2["Thu thập feedback"]
        E3["Theo dõi bảo hành"]
    end
...
| ------------------------------------ | ------------------------------------------- | --------------- |
| Tin nhắn chào mừng                   | Giới thiệu bản thân, SĐT, vai trò Account | Zalo            |
| Tạo nhóm Zalo chính thức            | KH + Account + PM                           | Zalo            |
...
```mermaid
flowchart TD
    A["KH phản ánh bức xúc"] --> B["Account lắng nghe TOÀN BỘ<br/>(Không ngắt lời, không bào chữa)"]
    B --> C["Ghi nhận & xin lỗi về trải nghiệm"]
    C --> D["Xác minh nội dung với PM/CA<br/>(Trong 2h)"]
    D --> E["Đề xuất giải pháp cho KH<br/>(Trong 4h)"]
    E --> F["Theo dõi đến khi giải quyết xong"]
    F --> G["Liên hệ KH xác nhận hài lòng"]
```
