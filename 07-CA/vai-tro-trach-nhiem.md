...
```mermaid
mindmap
  root((Construction Assistant))
    1. Quản Lý Kỹ Thuật
      Tiếp nhận hồ sơ thi công đã phê duyệt
      Giám sát chất lượng hằng ngày
      Nghiệm thu khối lượng, kỹ thuật
      Đình chỉ thi công khi có sai phạm
    2. Điều Phối Hiện Trường
      Cập nhật tiến độ biểu đồ Master Schedule
      Dự báo thời điểm tập kết vật tư/nhà thầu
      Quản lý không gian và an toàn thi công
    3. Báo Cáo & Xử Lý Sự Cố
      Thực hiện báo cáo tuần định kỳ
      Báo cáo khẩn cấp các rủi ro, sự cố
      Cung cấp thông tin khách hàng (qua PM)
```
