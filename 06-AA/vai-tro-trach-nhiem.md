...
```mermaid
mindmap
  root((Architect Assistant))
    1. Phối Hợp Thiết Kế
      Liên lạc hàng ngày ĐV TK
      Tổng hợp yêu cầu TK
    ...
    3. Quản Lý Hồ Sơ
      Lưu trữ hồ sơ TK
      Quản lý phiên bản bản vẽ
      Lưu trữ hồ sơ hoàn công
    4. Giám Sát Hoàn Thiện
      Ghi biên bản họp
      Cập nhật dữ liệu lên hệ thống
      Giám sát thi công nội thất
      Giám sát thi công hạng mục hoàn thiện
```
...
| ------------------ | --------------------------------------------------------------- | ------------ |
| **Account**  | - Báo cáo chênh lệch khối lượng/ngân sách (GĐ thiết kế).<br>- Tại các cuộc họp thiết kế, hỗ trợ Account tư vấn vật liệu, phối cảnh để Account chốt NCC với CĐT.<br>- Báo lịch thầu phụ vào công trường (GĐ thi công). | Thường xuyên |
...
```mermaid
flowchart LR
    A["📐 AA"] -->|"Kinh nghiệm kỹ thuật<br/>+ quản lý"| B["🎯 PM"]
    B -->|"Thử thách PO"| C["🏆 PO"]
