# Ma Trận RACI — Phân Quyền Trách Nhiệm

> **RACI** = Responsible (Thực hiện) · Accountable (Chịu trách nhiệm cuối) · Consulted (Được tham vấn) · Support (Hỗ trợ) · Informed (Được thông báo)
...
| **C**  | Consulted         | Được tham vấn ý kiến trước khi thực hiện             |
| **S**  | Support           | Hỗ trợ thực hiện                                           |
| **I**  | Informed          | Được thông báo kết quả sau khi hoàn thành             |
| **—** | Không liên quan | Không tham gia vào hoạt động này                         |

---

## Ma Trận RACI Theo Phase
...
| Lập Khái toán Ngân sách XN |     —     |    **S**    | **R** | **S** | — |      A      |  I  |
| Lập kế hoạch tổng thể      |     —     |      C      | **R** | **S** | C |      A      |  I  |
| Bổ nhiệm AA/CA                |     —     |      I      | **R** |     —     | — | **A** |  I  |
| Setup dự án trên hệ thống  |     —     |     —     | **R** |   I   | — |      A      |  —  |
| Cập nhật biên bản, hồ sơ lên hệ thống |     —     | **R** | **A** (kiểm soát) | **R** | **R** |      —      |  —  |

### PHASE 2: THIẾT KẾ

> 🔴 **PO trực tiếp chọn Đơn vị Thiết kế** — Account chỉ phối hợp, hỗ trợ, KHÔNG tham gia quyết định.
...
| Báo cáo tiến độ TK hàng tuần      |  —  |      I      | **A** | **R** | — |  I  |  —  |
| Nghiệm thu thiết kế                |  —  |      I      | **A** | **R** | — |  A  |  —  |

### PHASE 3: LỰA CHỌN NHÀ THẦU

> 🔴 **PO trực tiếp chọn Nhà thầu TC chính** — Account chỉ phối hợp, hỗ trợ, KHÔNG tham gia quyết định.
> 🟢 Đối tác khác (NTP, NCC): Account giới thiệu → PO duyệt → Đề xuất KH.
...
- **Trách nhiệm chính:** Phối hợp TK, kiểm tra bản vẽ, quản lý hồ sơ TK, hỗ trợ giám sát hoàn thiện & nội thất.
...
- **Trách nhiệm chính:** Quản lý Squad, chịu doanh số Squad, **xét duyệt cuối cùng mọi đề xuất đối tác cho KH**
- **Accountable cho:** Hiệu quả vận hành & doanh số Squad (~500M/tháng, ~25 công trình)
- **Quyền hạn:** **Trực tiếp chọn ĐV TK + NT thi công chính;** phê duyệt đề xuất ĐT khác từ Account; phê duyệt nhân sự Squad, Change Order, Escalation cấp 2
- **Báo cáo cho:** **PD (Project Director)**
- 👉 Chi tiết: [../02-PO/README.md](../02-PO/README.md)
...
- **Quyền hạn:** Xử lý Escalation cấp 3, quyết định chấm dứt dự án, quản lý lương thưởng PO
- **Báo cáo cho:** **BGĐ**
- 👉 Chi tiết: [../03-PD/README.md](../03-PD/README.md)
